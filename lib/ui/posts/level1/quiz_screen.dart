...
import 'package:asaf/ui/posts/level1/quiz_data.dart' as level1;
import 'package:asaf/ui/posts/level1/quizzes_screen.dart';
...
class QuizScreen extends StatefulWidget {
  final level1.QuizInfo quiz; // Add the parameter
    ...
    Future.delayed(const Duration(seconds: 2), () async {
      setState(() {
        if (isTimerExpired) {
          ...
          level1.QuizInfo completedQuiz = level1.quizzes[currentQuestionIndex];
