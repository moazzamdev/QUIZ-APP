...
import 'package:asaf/ui/posts/level5/quiz_data.dart' as level5;
import 'package:asaf/ui/posts/level5/quizzes_screen.dart';
...
class QuizScreen extends StatefulWidget {
  final level5.QuizInfo quiz; // Add the parameter
    ...
    Future.delayed(const Duration(seconds: 2), () async {
      setState(() {
        if (isTimerExpired) {
          ...
          level5.QuizInfo completedQuiz = level5.quizzes[currentQuestionIndex];
