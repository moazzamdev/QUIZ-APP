...
import 'package:asaf/ui/posts/level4/quiz_data.dart' as level4;
import 'package:asaf/ui/posts/level4/quizzes_screen.dart';
...
class QuizScreen extends StatefulWidget {
  final level4.QuizInfo quiz; // Add the parameter
    ...
    Future.delayed(const Duration(seconds: 2), () async {
      setState(() {
        if (isTimerExpired) {
          ...
          level4.QuizInfo completedQuiz = level4.quizzes[currentQuestionIndex];
