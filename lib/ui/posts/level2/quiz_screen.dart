...
import 'package:asaf/ui/posts/level2/quiz_data.dart' as level2;
import 'package:asaf/ui/posts/level2/quizzes_screen.dart';
...
class QuizScreen extends StatefulWidget {
  final level2.QuizInfo quiz; // Add the parameter
    ...
    Future.delayed(const Duration(seconds: 2), () async {
      setState(() {
        if (isTimerExpired) {
          ...
          level2.QuizInfo completedQuiz = level2.quizzes[currentQuestionIndex];
